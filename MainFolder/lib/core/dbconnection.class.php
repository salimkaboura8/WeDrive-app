...
//	self::$entityManager = \Doctrine\ORM\EntityManager::create($param, $config);
	...
	$dbresult = "is connected : ".self::$entityManager->getConnection()->getDatabase();
	echo '<div class="alert alert-success p-1" id="bandeau" role="alert">'.$dbresult.'  </div>';
